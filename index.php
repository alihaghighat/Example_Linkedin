        ...
        <div class="form-form-wrap">
            <div class="form-container">
                <div class="form-content">
                    ...
                    <h1 class="">ورود</h1>
                    <p class="">برای ورود اطلاعات  را وارد بفرمایید</p>
                    ...
                    <div class="social mt-4">
                        <a href="Register" class="btn social-fb">
                            <span class="brand-name">ثبت نام</span>
                        </a>
...
<script>
    function mywork(){
        ...
        if(u!='' && p!=''){
            ...
            alert('Password or username not filled in');
